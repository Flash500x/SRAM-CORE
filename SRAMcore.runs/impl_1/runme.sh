...
HD_PWD='C:/Users/asus/Downloads/Verilog/SRAMcore/SRAMcore.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wr_rd_fsm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wr_rd_fsm.tcl -notrace
