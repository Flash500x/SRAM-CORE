...
HD_PWD='C:/Users/asus/Downloads/Verilog/SRAMcore/SRAMcore.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wr_rd_fsm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wr_rd_fsm.tcl
